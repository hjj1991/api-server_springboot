...
public class CategoryController {
    ...
    public ApiResponse_Java categoryAdd(UserEntity user, @RequestBody CategoryDto.RequestCategoryAddForm form) {
        try {
    ...
    @GetMapping("/category")
    public ApiResponse_Java categoryList(UserEntity user, @RequestParam(value = "accountBookNo") Long accountBookNo) {
        try {
    ...
    public ApiResponse_Java categoryDetails(UserEntity user, @ApiParam(value = "categoryNo", required = true) @PathVariable("categoryNo") Long categoryNo) {
        try {
    ...
    public ApiResponse_Java categoryModify(UserEntity user, @ApiParam(value = "categoryNo", required = true) @PathVariable("categoryNo") Long categoryNo, @Valid @RequestBody CategoryDto.RequestCategoryModifyForm form) {
        try {
            CategoryDto categoryDto = modelMapper.map(form, CategoryDto.class);
            categoryDto.setUserNo(user.getUserNo());
    ...
    public ApiResponse_Java categoryRemove(UserEntity user, @ApiParam(value = "categoryNo", required = true) @PathVariable("categoryNo") Long categoryNo, @RequestBody CategoryDto.RequestCategoryRemoveForm form) {
        try {
