...
@DynamicUpdate
@Getter
public class PurchaseEntityJava extends BaseEntityJava {
    ...
    public void changeCategoryEntity(CategoryEntityJava categoryEntity){
    ...
    public PurchaseEntityJava updatePurchase(PurchaseDto purchaseDto){
