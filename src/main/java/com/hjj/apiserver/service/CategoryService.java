...
public class CategoryService {
    ...
    public List<CategoryDto.ResponseCategory> findCategory(Long userNo){
        List<CategoryEntity> categoryEntityList = categoryRepository.findEntityGraphByUserInfo_UserNoAndParentCategory_CategoryNo(userNo, null);
    ...
    public void modifyCategory(CategoryDto categoryDto) throws Exception {
        CategoryEntity updateCategory =  categoryRepository.findByCategoryNoAndUserInfo_UserNo(categoryDto.getCategoryNo(), categoryDto.getUserNo()).orElseThrow(UserNotFoundException::new);
    ...
    public void deleteCategory(Long categoryNo, Long userNo) throws UserNotFoundException {
        CategoryEntity categoryEntity = categoryRepository.findByCategoryNoAndUserInfo_UserNo(categoryNo, userNo).orElseThrow(UserNotFoundException::new);
