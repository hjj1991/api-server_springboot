...
class PurchaseService(
    ...
    fun addPurchase(
        userNo: Long,
        request: PurchaseAddRequest,
    ): PurchaseAddResponse {
        val accountBook =
            accountBookRepository.findAccountBook(
                userNo = userNo,
        ...
        val purchase =
            request.toEntity(
                card,
                category,
                userRepository.getReferenceById(userNo),
    ...
    fun removePurchase(
        ...
        purchaseRepository.findEntityGraphByUserEntityUserNoAndPurchaseNoAndIsDeleteIsFalse(userNo, purchaseNo)?.delete()
    ...
    fun modifyPurchase(
        ...
        val purchase =
            purchaseRepository.findEntityGraphByUserEntityUserNoAndPurchaseNoAndIsDeleteIsFalse(userNo, purchaseNo)
                ?: throw PurchaseNotFoundException()

        val card =
            request.cardNo?.let {
                cardRepository.findByCardNoAndUserEntityUserNoAndIsDeleteIsFalse(it, userNo) ?: throw CardNotFoundException()
            }
        val category =
            request.categoryNo?.let {
                categoryRepository.findCategoryByAccountRole(
