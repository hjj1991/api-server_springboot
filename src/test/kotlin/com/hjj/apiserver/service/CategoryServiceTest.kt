...
class CategoryServiceTest {
    ...
    fun addCategory_success_exists_parentCategory() {
        ...
        Mockito.`when`(
            categoryRepository.findCategoryByCategoryNoAndAccountBook_AccountBookNoAndIsDeleteIsFalse(
    ...
    fun findAllCategories_success() {
        ...
        val category2 = CategoryDto(
            ...
            categoryIcon = "",
            accountBookNo = accountBook.accountBookNo!!,
            childCategories = listOf(CategoryDto.ChildCategory(
                categoryNo = 3L,
                categoryName = "자식카테고리",
    ...
    fun modifyCategory_success() {
        ...
        Mockito.`when`(categoryRepository.findCategoryByAccountRole(category.categoryNo!!, categoryModifyRequest.accountBookNo, savedUser.userNo!!,
    ...
    fun modifyCategory_fail_when_parentCategory_not_found_throw_CategoryNotFoundException() {
        ...
        Mockito.`when`(categoryRepository.findCategoryByCategoryNoAndAccountBook_AccountBookNoAndIsDeleteIsFalse(
            10L, accountBook.accountBookNo!!
        )).thenReturn(null)
    ...
    fun deleteCategory_success() {
        ...
        Mockito.`when`(categoryRepository.findCategoryByAccountRole(category.categoryNo!!, accountBook.accountBookNo!!,
            savedUser.userNo!!, setOf(AccountRole.OWNER)
        )).thenReturn(category)
    ...
    fun deleteCategory_fail_when_categoryNotExists_throw_categoryNotFoundException() {
        ...
        Mockito.`when`(categoryRepository.findCategoryByAccountRole(1L, 1L,
            savedUser.userNo!!, setOf(AccountRole.OWNER)
        )).thenReturn(null)
