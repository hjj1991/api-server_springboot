...
class JwtProviderTest {
    ...
    fun createTokenTest_success() {
        ...
        // When
        val token = jwtProvider.createToken(user, TokenType.ACCESS_TOKEN)

        // Then
        Assertions.assertThat(token).isEqualTo("eyJ0eXAiOiJKV1QiLCJhbGciOiJIUzUxMiJ9.eyJzdWIiOiIxMSIsImV4cCI6MzI0NzIxODEyMDAsImlhdCI6MzI0NzIxODAwMDB9.qK5PVaTQbrjT1izWB5VZ8JkwRUQlh16Yh7m3a9uq-bLbg5M4R5WrpIZ7Re1i33D90tvLwOCGMYcKSBX3A6Gcvw")
    }
    ...
    fun isValidTokenTest_fail_when_expiredToken() {
        ...
        val user = User(userNo = 11L, nickName = "tester")
        val token = jwtProvider.createToken(user, TokenType.ACCESS_TOKEN)
        val pastJwtProvider = JwtProvider(
