...
class UserControllerTest {
    ...
    inner class CheckUserNickNameDuplicateTest {
        @DisplayName("변경할 닉네임이 존재하는지 확인하여 존재하면 400 Error.")
        @Test
        fun checkUserNickNameDuplicateTestWhenexistsnickNameThenTrue() {
            ...
            val existsNickNameResponse = ApiError(ErrConst.ERR_CODE0003, message = ErrConst.ERR_CODE0003.msg, null)
            BDDMockito.given(getUserUseCase.existsNickName(checkUserNickNameDuplicateCommand))
                .willThrow(DuplicatedNickNameException::class.java)
            ...
            mockMvc.perform(
                ...
                .andDo(
                    MockMvcRestDocumentationWrapper.document(
                        ...
                        PayloadDocumentation.responseFields(ApiDocumentUtil.getBaseErrorResponse()),
                        ResourceDocumentation.resource(
                            ResourceSnippetParameters.builder()
                                .description("닉네임 존재하는 경우")
                                .tag(USER_TAG)
                                .responseFields(ApiDocumentUtil.getBaseErrorResponse())
                                .requestHeaders(
        ...
        @DisplayName("유저가 변경할 유저 닉네임이 존재하지 않으면 NoContent")
        @Test
    ...
    inner class CheckUserIdDuplicateTest {
        @DisplayName("변경할 유저 아이디가 존재하는지 확인하여 존재하면 Bad Request.")
        @Test
        @WithMockUser
        fun checkUserIdDuplicateTestWhenExistsUserIdThenTrue() {
            ...
            BDDMockito.given(userCredentialUseCase.existsUserId(userId))
                .willThrow(DuplicatedUserIdException::class.java)

            val existsUserIdResponse = ApiError(ErrConst.ERR_CODE0002, message = ErrConst.ERR_CODE0002.msg, null)
            // When && Then
            mockMvc.perform(
                    ...
                    MockMvcRestDocumentationWrapper.document(
                        ...
                        ResourceDocumentation.resource(
                            ResourceSnippetParameters.builder()
                                ...
                                .tag(USER_TAG)
                                .responseFields(
                                    ApiDocumentUtil.getBaseErrorResponse(),
                                ).build(),
                        ),
                    ),
                )
        ...
        @DisplayName("변경할 유저 아이디가 존재하지 않으면 NoContent")
        @Test
        @WithMockUser
...
//
//            val alreadyExsistsUserResponse = ApiError(ErrConst.ERR_CODE0006, ErrConst.ERR_CODE0006.msg)
//
//            // When && Then
//            mockMvc.perform(
//                RestDocumentationRequestBuilders.post("/users/signup")
...
//                    refreshToken = "refreshToken",
//                )
//            val userNotFoundExceptionResponse = ApiError(ErrConst.ERR_CODE0001, ErrConst.ERR_CODE0001.msg)
